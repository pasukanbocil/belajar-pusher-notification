...
<head>
    ...
    <script>
        ...
        var pusher = new Pusher('5e502e672999980e97f1', {
            cluster: 'ap1'
        });

        var channel = pusher.subscribe('belajar-puhser-notificatio');
        channel.bind('user-register', function(data) {
            toastr.info(' Kamu dapet orderan baru nih dari ' + JSON.stringify(data.name));
        });
    </script>
</head>
